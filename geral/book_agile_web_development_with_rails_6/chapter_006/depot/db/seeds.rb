...
Product.create!(title: 'Docker for Rails Developers', description: description, image_url: 'ridocker.jpg', price: 38.00)
...
Product.create!(title: 'Build Chatbot Interactions', description: description, image_url: 'dpchat.jpg', price: 20.00)
...
Product.create!(title: 'Programming Crystal', description: description, image_url: 'crystal.jpg', price: 40.00)
