...
+ To add single document to an index, submit an HTTP post request that targets the index
  ...
  #+begin_src bash
    curl --cacert http_ca.crt -u elastic -XPOST -H "Content-Type: application/json" "https://localhost:9200/customer/_doc/1 \
...
#+begin_src bash
  curl --cacert http_ca.crt -u elastic -XPOST -H "Content-Type: application/json" "https://localhost:9200/customer/_bulk \
    '{ "create": {} }\n{ "firstname": "Monica", "lastname": "Rambeau" }\n{ "create": {} }{ "firstname": "Carol", "lastname": "Danvers" }'
#+end_src
