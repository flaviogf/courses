...
{
    public class SignInGitHub : Controller
    {
        ...
        {
            var url = Url.Action("Store", "SignInGitHub");

            var properties = _signInManager.ConfigureExternalAuthenticationProperties("GitHub", url);
